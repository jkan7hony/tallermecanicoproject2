    ...
    <div class="row justify-content-center w-100">
        <div class="col-12 col-lg-8 col-xl-7">
            ...
            <div class="text-center mb-4">
                ...
                <h2 class="fw-bold text-white">Editar Cliente</h2>
                <p class="text-secondary">Actualiza los datos de <strong>{{ $cliente->nombre }} {{ $cliente->apellido }}</strong></p>
            </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="input-group custom-group">
                                        ...
                                        <input type="text" name="rut" value="{{ old('rut', $cliente->rut) }}" 
                                               ...
                                               placeholder="12.345.678-9" readonly>
                                    </div>
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group custom-group">
                                        ...
                                        <input type="text" name="telefono" value="{{ old('telefono', $cliente->telefono) }}" maxlength="9" inputmode="numeric" pattern="[0-9]{1,9}" 
        ...
        if (form) {
            form.addEventListener('submit', function(e) {
                ...
                if (!nombreInput.value.trim()) {
                    e.preventDefault();
                    showToast('⚠️ El nombre es requerido', 'danger');
                    nombreInput.focus();
                    return;
                }
                if (!apellidoInput.value.trim()) {
                    e.preventDefault();
                    showToast('⚠️ El apellido es requerido', 'danger');
                    apellidoInput.focus();
                    return;
                }
                if (!telefonoInput.value.trim()) {
                    e.preventDefault();
                    showToast('⚠️ El teléfono es requerido', 'danger');
                    telefonoInput.focus();
                    return;
                }
                if (!emailInput.value.trim()) {
                    e.preventDefault();
                    showToast('⚠️ El email es requerido', 'danger');
                    emailInput.focus();
                    return;
                }
            });
